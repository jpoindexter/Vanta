...
- Calibrated the signed-package cold-start budget against fresh local and hosted macOS ARM64 measurements while retaining the 25% regression rule and 10-second hard ceiling.
