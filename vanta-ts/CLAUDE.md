...
| `tools/index.ts` | `buildRegistry({exclude?})` — registers all 46 tools + `mount_mcp` via factory = 47 total (`exclude:["delegate"]` → 46 for workers); `roadmap_add` files new cards, `roadmap_move` changes status |
