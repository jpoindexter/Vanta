...
**Comment convention:** code comments + commit messages stay Vanta-native — no Claude Code / `CC-` / the reference agent provenance (the real `claude-code` provider integration + roadmap card-ids are kept).
