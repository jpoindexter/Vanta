...
| `tools/index.ts` | `buildRegistry({exclude?})` — registers all 47 tools + `mount_mcp` via factory = 48 total (`exclude:["delegate"]` → 47 for workers); `roadmap_add` files new cards, `roadmap_move` changes status |
