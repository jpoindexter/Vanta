...
| `tools/index.ts` | `buildRegistry({exclude?})` — registers all 43 tools + `mount_mcp` via factory = 44 total (`exclude:["delegate"]` → 42 for workers); `roadmap_add` files new cards, `roadmap_move` changes status |
