...
// No deps — plain Node, run: node vanta-ts/scripts/build-audit.mjs
...
<div class="stamp">generated ${esc(d.generated)} · source: audit.json (agent-ready) · regenerate: node vanta-ts/scripts/build-audit.mjs</div>
</header>
<nav>
