...
- Cards added this full audit: 142 new roadmap items (102 p1-4 + 12 p5 + 13 p6 + 9 p7 + 6 p8)
...
- Pass 8: 6 cards (tools/ long-tail: AskUserQuestion, McpAuth, StructuredOutput, CronDurable, SendMessage, TeamTools) → NOT stopped yet
