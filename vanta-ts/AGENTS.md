...
- `src/repl/catalog.ts` — canonical list of 136 slash commands for `/help`, TUI palette, and validation; `/skills audit` exposes skill injection-scan findings without noisy default loads
...
- `src/repl/catalog.ts` currently exposes **136 slash commands**.
