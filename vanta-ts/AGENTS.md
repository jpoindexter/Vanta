...
- `src/repl/catalog.ts` — canonical list of 137 slash commands for `/help`, TUI palette, and validation; `/skills audit` exposes skill injection-scan findings without noisy default loads
...
- `src/repl/catalog.ts` currently exposes **137 slash commands**.
