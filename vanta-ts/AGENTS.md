...
```bash
npx vitest run                   # last full green: 4318 tests (from vanta-ts/)
...
- `src/repl/catalog.ts` — canonical list of 102 slash commands for `/help`, TUI palette, and validation
...
- `src/repl/catalog.ts` currently exposes **102 slash commands**.
