...
- Fleet workers emit `TaskCreated` when assigned and `TaskCompleted` when they finish successfully; blocked workers remain represented by team-task status records.
