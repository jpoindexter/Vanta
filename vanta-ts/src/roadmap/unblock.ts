...
const KNOWN_ACTIONS: Record<string, string[]> = {
  ...
  "PAYMENT-ADYEN-AGENTIC-DELEGATED": [
    "Request Adyen Agentic test-program access and the current Agentic Payments integration contract; public launch material is not an API schema.",
    "After approval, implement only the provider fields and authentication mechanism Adyen supplies; keep PAN/CVC and provider tokens outside model context.",
    "Execute an approved Adyen test-account authorization and the denial, expiry, replay, customer-authentication, charge, and redacted-receipt scenarios named by the card.",
    "Bind the authorized receipt and redacted provider evidence with `vanta roadmap proof-record PAYMENT-ADYEN-AGENTIC-DELEGATED <event-id> --evidence <file> --yes`.",
  ],
