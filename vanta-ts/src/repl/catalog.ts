...
export const SLASH_COMMANDS: ReadonlyArray<{ name: string; arg?: string; desc: string }> = [
  ...
  { name: "activity", desc: "who/what/why timeline over the event log — /activity [--who tool] [--kind gate|tool|note] [--risk ask|blocked] [--since 2h] [--limit N] [text]" },
  ...
  { name: "plugin-panels", desc: "open data-only panels contributed by isolated plugin workers (TUI)" },
  ...
  { name: "suggest", desc: "recap + ranked next-step (top 3); '/suggest all' for the full backlog" },
  { name: "time", desc: "session elapsed + time since last action (ND-TIME-RANGES)" },
  ...
  { name: "schema-quality", arg: "[summary]", desc: "show exact, partial, untested, and contradicted model quality" },
  ...
  { name: "learning", desc: "self-learning loop status — skills minted/refined/adopted + adoption rate" },
