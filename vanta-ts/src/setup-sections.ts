...
export const SETTINGS: SettingSection[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { label: "remote sandbox — Modal (your account, opt-in)", env: { VANTA_EXEC_BACKEND: "serverless", VANTA_SERVERLESS_PROVIDER: "modal", VANTA_SERVERLESS_NET: "0", VANTA_SANDBOX: "0" }, urlEnv: "VANTA_SERVERLESS_APP", urlHint: "Modal app name (optional; authenticate, then run vanta backend verify)" },
