...
- Tool count: **123 built-in** in `ALL_TOOLS`, **127 registered** (+ factory `mount_mcp` + `tool_search` + `mcp_auth`) — 2026-06-26 (added `build_with_agent`). Update both numbers after a registry change.
