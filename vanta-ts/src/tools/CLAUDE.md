...
- Tool count: **143 built-in** in `ALL_TOOLS`, **147 registered** (+ factory `mount_mcp` + `tool_search` + `mcp_auth` + `run_pipeline`) — real-counted 2026-07-29. Update both numbers after a registry change.
