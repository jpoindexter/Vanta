...
- Tool count: **123 built-in** in `ALL_TOOLS`, **127 registered** (+ factory `mount_mcp` + `tool_search` + `mcp_auth` + `run_pipeline`) — real-counted 2026-07-09. Update both numbers after a registry change.
