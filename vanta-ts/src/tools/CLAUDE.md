...
- Tool count: **125 built-in** in `ALL_TOOLS`, **129 registered** (+ factory `mount_mcp` + `tool_search` + `mcp_auth` + `run_pipeline`) — real-counted 2026-07-10. Update both numbers after a registry change.
