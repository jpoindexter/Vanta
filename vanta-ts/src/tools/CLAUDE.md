...
- Tool count: **146 built-in** in `ALL_TOOLS`, **150 registered** (+ factory `mount_mcp` + `tool_search` + `mcp_auth` + `run_pipeline`) — real-counted 2026-08-17. Update both numbers after a registry change.
