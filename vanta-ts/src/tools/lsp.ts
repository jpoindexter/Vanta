...
// The position-based capabilities (references/symbols/hover) are extracted to
// lsp-extra-tools.ts for the size gate, then re-exported below so importers keep
// the same `./lsp.js` module path.
export {
  lspReferencesTool,
  lspSymbolsTool,
  lspHoverTool,
} from "./lsp-extra-tools.js";
