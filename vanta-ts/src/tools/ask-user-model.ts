...
// ───────────────────────────────────────────────────────────────────────────
// VANTA-ASK-USER-MODEL — the pure question-set model the `ask_user` tool sits
// on. Schema + types + sanitize/validate/format/resolve, all pure and host-
// agnostic: parse a model-supplied question set, format it for surfacing, and
// resolve an operator's raw picks back to option labels. No I/O, no Tool.
// ───────────────────────────────────────────────────────────────────────────
