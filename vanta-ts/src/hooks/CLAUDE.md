...
- Paper parity: `paper-events.ts` encodes arXiv:2604.14228's 27 hook events. Current status: all 27 are supported; Vanta adds `UserPromptExpansion`, `MessageDisplay`, and `PostToolBatch`.
