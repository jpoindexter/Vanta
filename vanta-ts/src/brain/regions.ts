// Vanta's "brain" — a set of human-brain-inspired regions, each a markdown file
...
// versioned. This is how Vanta grows a durable self: identity, memory, a model of
...
export const BRAIN_REGIONS: readonly BrainRegion[] = [
  ...
  },
  {
    ...
    description: "Durable facts Vanta knows about the world, the user, and the codebase. Append facts that stay true.",
  ...
  },
  {
    ...
    description: "Standing wants and what Vanta is working toward, beyond the current task.",
    seed:
  ...
  },
  {
    ...
    description: "Lessons learned, self-critique, mistakes to avoid, what Vanta is improving about itself.",
    seed: "# Reflections\n\nLessons, self-critique, and what I'm improving.\n",
  },
  {
    name: "mood",
    title: "Mood / Operating State",
    description: "Vanta's current affective and operating state — kept brief.",
    seed: "# Mood\n\nSteady and ready.\n",
  },
