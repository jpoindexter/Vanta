...
describe("memory store", () => {
  ...
  it("secret-scanner: a summary with a credential is not persisted and reports the rule", async () => {
  ...
  it("secret-scanner: clean content is written and reports not-skipped", async () => {
  ...
  it("memory freshness: an old block gets a staleness caveat; a fresh one does not", async () => {
