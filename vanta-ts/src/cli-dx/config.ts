...
const VANTA_KEYS = [
  ...
  "VANTA_MODAL_GATEWAY_APP",
  "VANTA_MODAL_GATEWAY_SECRET",
  "VANTA_MODAL_GATEWAY_VOLUME",
  "VANTA_MODAL_GATEWAY_MIN_CONTAINERS",
  "VANTA_MODAL_GATEWAY_SCALEDOWN_SEC",
];
