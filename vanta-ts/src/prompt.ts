...
function stableTier(soul: string, root: string, tools: ToolSchema[]): string {
  ...
  return [
    ...
    `4. Never declare a task complete without verified tool output proving it — cite the command and its result; do not claim "done", "fixed", or "working" in prose alone.`,
