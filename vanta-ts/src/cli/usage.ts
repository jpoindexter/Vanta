const USAGE_LINES = [
      ...
      "       vanta local-model profiles <command>               create, validate, import, export, and select runtime profiles",
      ...
      "       vanta doctor [--limit N]            health + read-only context-engineering audit",
