const USAGE_LINES = [
      ...
      "       vanta run-anywhere status [--json]   aggregate Modal/Teams/Termux release proof readiness",
      ...
      "       vanta gateway channel-proofs [platform]   show accepted inbound-to-reply receipts",
