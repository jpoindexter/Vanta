...
import type { FactoryConfig, CycleResult, AutonomyLevel, FactoryDeps, FactoryPlan, WorkItem, SliceArtifact } from "./types.js";
...
type CycleCtx = { config: FactoryConfig; item: WorkItem; deps: FactoryDeps; log: (msg: string) => void };
 ...
 */
async function executeWithVerify(
  ctx: CycleCtx,
  plan: FactoryPlan,
 ...
 */
async function landVerifiedSlice(
  ctx: CycleCtx,
  branch: string,
  startBranch: string,
