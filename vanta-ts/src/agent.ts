...
async function dispatchTool(
  ...
  // CC-TOOL-RESULT-DISK: size-based backstop AFTER lossy compression. Catches
  // any tool (incl. non-allow-listed reads/shell) whose output is still oversized,
  // stashing it whole and replacing it with a preview + retrieval id.
