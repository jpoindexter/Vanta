...
- `nl-assertions.ts` judges captured input/output pairs against plain-English assertions with a separate provider call; malformed judge output fails closed.
