...
export type OverlayKind = "model" | "sessions" | "skills" | "cockpit" | "help" | "loops" | "review" | "context" | "mcp" | "tasks" | "sandbox";
...
export const PICKER_KINDS: Readonly<Record<string, OverlayKind>> = {
  ...
  loops: "loops", changes: "review", context: "context", mcp: "mcp", agents: "tasks", sandbox: "sandbox",
};
