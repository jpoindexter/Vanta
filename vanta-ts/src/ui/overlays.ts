...
export type OverlayKind = "model" | "sessions" | "skills" | "cockpit" | "help" | "loops" | "review" | "context" | "mcp" | "tasks" | "teams" | "memory" | "workflowSelect" | "outputStyle" | "export" | "sandbox" | "config" | "stats" | "hooks";
...
export const PICKER_KINDS: Readonly<Record<string, OverlayKind>> = {
  ...
  loops: "loops", changes: "review", context: "context", mcp: "mcp", agents: "tasks", teams: "teams", memory: "memory", "workflow-select": "workflowSelect", "output-style": "outputStyle", export: "export", sandbox: "sandbox", config: "config", stats: "stats", hooks: "hooks",
};
