...
- The notarized macOS app completed real chat and blocked a destructive terminal command at the kernel boundary; v0.9.4 adds a cold-start regression gate over the same packaged desktop surface.
