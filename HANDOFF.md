...
- **Last recorded full verify:** 3732 TS tests green (479 files), `tsc` clean, 53 kernel tests green (see `vanta-ts/CLAUDE.md` 2026-06-19 notes)
...
- Paper hook parity: `vanta-ts/src/hooks/paper-events.ts` maps arXiv:2604.14228v1 §6's 27 hook events to Vanta's hook vocabulary; tests require zero missing paper events and name Vanta's extras (`UserPromptExpansion`, `MessageDisplay`, `PostToolBatch`).
