...
## Part 2 — Claude Code → Vanta capability delta

What the Claude Code harness does ("what you do") vs what Vanta has. **Vanta already has
most of it** — the genuine gaps are clickability and clean transcript structure.

| Claude Code capability | Vanta today | Gap → item |
|---|---|---|
