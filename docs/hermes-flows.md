# Hermes → Vanta: Full Flow Map & Port Plan
...
| Hermes protocol bucket | Vanta equivalent |
|---|---|
...
Hermes has ~75 backend commands; the TUI exposes an interactive subset. Vanta's
...
flows that make Vanta more than a Hermes clone.
