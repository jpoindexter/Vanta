...
5. Add runtime profiles and downloads only after lifecycle receipts are proven.
6. Join runtime telemetry to the existing usage ledger and release proof suite.
