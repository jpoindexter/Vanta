...
001. [next] TRUST-04 — Truthful completion and one typed receipt across every host
...
002. [next] TRUST-01 — Universal effect-path inventory and one trusted action gateway
...
003. [next] OP-01 — Minimum operator spine — WorkItem, Run, Approval, Receipt, follow-up, and resume
...
004. [next] GROW-01 — Phase-0 trusted-continuity evidence lane — interviews, pilots, burden, retention, and price
...
005. [horizon] TRUST-03 — Canonical action envelope and scoped capability
...
006. [horizon] TRUST-05 — Untrusted-content quarantine across email, web, documents, messages, and social input
    track: Harness | tier: rock | size: L | effort: high | model: opus | after: TRUST-01, TRUST-02
...
007. [horizon] TRUST-06 — Safe factory, self-repair, and Vanta Lab production boundary
...
008. [horizon] OP-03 — Trustworthy Needs You — deterministic, deduplicated, expiring, and auto-resolving
...
009. [horizon] UX-04 — Contextual Review, first-run usefulness, and cross-host accessibility contract
...
010. [horizon] LIFE-02 — Quarantined read-only morning orientation
