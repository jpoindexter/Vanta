...
003. [horizon] TRUST-05 — Untrusted-content quarantine across email, web, documents, messages, and social input
    track: Harness | tier: rock | size: L | effort: high | model: opus | after: TRUST-01, TRUST-02
...
004. [horizon] TRUST-06 — Safe factory, self-repair, and Vanta Lab production boundary
...
005. [horizon] OP-03 — Trustworthy Needs You — deterministic, deduplicated, expiring, and auto-resolving
...
006. [horizon] UX-04 — Contextual Review, first-run usefulness, and cross-host accessibility contract
...
007. [horizon] LIFE-02 — Quarantined read-only morning orientation
