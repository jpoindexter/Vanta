...
002. [next] TRUST-04 — Truthful completion and one typed receipt across every host
...
003. [next] TRUST-01 — Universal effect-path inventory and one trusted action gateway
...
004. [next] OP-01 — Minimum operator spine — WorkItem, Run, Approval, Receipt, follow-up, and resume
...
005. [next] GROW-01 — Phase-0 trusted-continuity evidence lane — interviews, pilots, burden, retention, and price
...
011. [horizon] LIFE-02 — Quarantined read-only morning orientation
