...
001. [next] OP-01 — Minimum operator spine — WorkItem, Run, Approval, Receipt, follow-up, and resume
...
002. [next] GROW-01 — Phase-0 trusted-continuity evidence lane — interviews, pilots, burden, retention, and price
...
003. [horizon] TRUST-03 — Canonical action envelope and scoped capability
...
004. [horizon] TRUST-05 — Untrusted-content quarantine across email, web, documents, messages, and social input
    track: Harness | tier: rock | size: L | effort: high | model: opus | after: TRUST-01, TRUST-02
...
005. [horizon] TRUST-06 — Safe factory, self-repair, and Vanta Lab production boundary
...
006. [horizon] OP-03 — Trustworthy Needs You — deterministic, deduplicated, expiring, and auto-resolving
...
007. [horizon] UX-04 — Contextual Review, first-run usefulness, and cross-host accessibility contract
...
008. [horizon] LIFE-02 — Quarantined read-only morning orientation
