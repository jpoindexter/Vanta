...
**v1 complete; roadmap-grind in progress (2026-06-07).** Full v1 Hermes parity + Phase 2 EF + all S/M/L roadmap extensions. **46 tools** (+ compose_workflow + graph_query + roadmap_add) · **1201 TS + 27 Rust = 1228 tests green.**
