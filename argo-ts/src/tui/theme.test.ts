...
describe("resolveTheme", () => {
  it("returns default theme when ARGO_THEME is unset", () => {
  ...
  it("returns high-contrast theme", () => {
    const t = resolveTheme({ ARGO_THEME: "high-contrast" });
