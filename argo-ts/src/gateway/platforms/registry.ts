...
export const MESSAGING_CATALOG: MessagingPlatform[] = [
  {
    ...
    label: "Telegram",
    implemented: true,
    requiredEnv: ["ARGO_TELEGRAM_TOKEN"],
    secretEnv: "ARGO_TELEGRAM_TOKEN",
    signupUrl: "https://t.me/BotFather",
    setupSteps: [
      "Open @BotFather in Telegram.",
      "Send /newbot and follow the prompts to name your bot.",
      "Copy the HTTP API token BotFather gives you.",
      "Paste it here. Optionally set ARGO_TELEGRAM_ALLOW to a comma list of chat ids.",
    ],
  },
  {
    id: "imessage",
    ...
    implemented: false,
    requiredEnv: ["ARGO_IMESSAGE_ENABLE"],
    enableEnv: { ARGO_IMESSAGE_ENABLE: "1" },
    prerequisite:
  ...
  },
  {
    ...
    setupSteps: [
      ...
      "Set ARGO_SIGNAL_URL to that daemon URL.",
    ],
  },
  {
    id: "whatsapp",
    ...
    implemented: false,
    requiredEnv: ["ARGO_WHATSAPP_ENABLE"],
    enableEnv: { ARGO_WHATSAPP_ENABLE: "1" },
