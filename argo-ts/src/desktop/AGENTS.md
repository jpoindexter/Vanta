# AGENTS.md — argo-ts/src/desktop

Local command-center surface for Argo.

- Keep this as a thin UI host over existing Argo runtime primitives (`prepareRun`, `createConversation`, `SafetyClient`).
