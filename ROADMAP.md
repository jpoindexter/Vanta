...
and **93 slash commands**. Last recorded full verify: **3266 TS tests**, `tsc` clean,
kernel tests green.
...
and resume forking are live slices; browser OS-level control and deeper ambient channels remain horizon.
