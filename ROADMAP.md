...
and **93 slash commands**. Last recorded full verify: **3251 TS tests**, `tsc` clean,
kernel tests green.
...
self-repair, background agent CLI management, `/init`, lifecycle init flags, and resume forking are
live slices; browser OS-level control and deeper ambient channels remain horizon.
