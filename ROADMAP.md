...
and **93 slash commands**. Last recorded full verify: **3276 TS tests**, `tsc` clean,
kernel tests green.
...
resume forking, the opt-in TUI v2 mission-control shell, and the Vite/React desktop renderer are live slices; browser OS-level
