...
and **93 slash commands**. Last recorded full verify: **3271 TS tests**, `tsc` clean,
kernel tests green.
...
resume forking, and the opt-in TUI v2 mission-control shell are live slices; browser OS-level
