...
**AUTOMATE** — workflow can be fully automated with existing tools (Codex Cowork, Zapier, n8n, custom scripts). No human judgment required. The trigger, decision rules, and output are fully specifiable.
...
- Tool: [Codex Cowork / Zapier / custom / other]
